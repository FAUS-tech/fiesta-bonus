...
def build_readme(wb):
    ...
    rows = [
        ...
        ('REN', 'T1 $25k=$250 | T2 $40k=$350 | T3 $65k=$450 | T4 $80k=$550 | T5 $100k=$800. Above $100k: +$40 per $5k. Gate: 30% retention rate.'),
...
def build_current_vs_new_comparison(wb):
    ...
    ws['A2'] = ("CURRENT = today's plan: count NB+RWR policies, 30/38/50 tier -> $250/$350/$450 + $10/policy above 50. "
                "NEW = the new tier-based plan (NB + RWR + REN combined). "
